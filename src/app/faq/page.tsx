      ...
      return (
            <div className="font-['Plus Jakarta Sans'] text-gray-800 bg-gradient-to-r from-[#A2D6EB] to-[#F3F0EA] min-h-screen relative overflow-hidden">
                  ...
                  <nav className="flex flex-wrap justify-between items-center py-4 px-6 md:px-32 border-b relative z-20 bg-transparent">
                        ...
                        <ul
                              className={`w-full md:w-auto ${menuOpen ? 'block' : 'hidden'} md:flex space-y-2 md:space-y-0 md:space-x-6 mt-4 md:mt-0 text-[16px] md:text-[18px] font-extrabold`}
                        >
                              {navItems.map((item) => (
                                    <li key={item.href}>
                                          <Link
                        ...
                        {faqs.map((faq, index) => (
                              ...
                              >
                                    <div className="flex justify-between items-center">
                                          <h3 className="font-semibold text-md md:text-lg">{faq.question}</h3>
                  ...
                  {/* Footer */}
                  <footer className="bg-gray-900 text-white py-10 px-6 md:px-8 text-xs sm:text-sm mt-20">
